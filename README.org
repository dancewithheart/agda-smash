...
#+NAME:   fig:CI-Bade
[[https://github.com/dancewithheart/agda-smash/actions/workflows/main.yml/badge.svg?branch=main]]
...
will give sth like
#+BEGIN_SRC text
/nix/store/somehash-agdaWithPackages-2.8.0/bin/agda
#+END_SRC
